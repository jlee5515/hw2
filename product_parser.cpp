...
{
    Product* bookthing = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
    return bookthing;
}
...
{
	Product* clothingthing = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
	return clothingthing;
}
...
{
	Product* moviething = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
	return moviething;
}
